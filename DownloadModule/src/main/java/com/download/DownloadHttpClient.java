...
public class DownloadHttpClient extends HttpClient {
     ...
     * 下载
     */
    public ResponseData download(DownloadManager.Request request, DownloadListener listener) {
...
//            if (file.exists()) {
//                raf = new RandomAccessFile(param.getFileName(), "rw");
...
//    private void checkDownloadStatus(DownloadRequest param){
